    ...
    while exit_game != True:
        if game_over == True:
            ...
            if obstacle_y2 >= window_height:
                ...
                obstacle_x2 +=50
            if score > 300:
                obstacle_x3 = random.randint(0,window_height)
                obstacle_y3 = random.randint(0,window_height)
            ...
            pygame.draw.rect(gameWindow,black,[obstacle_x4,obstacle_y4,obstacle_size4,obstacle_size4])
            ...
            if abs(snake_x - obstacle_x4)<20 and abs(snake_y - obstacle_y4)<20:
                ...
                #pygame.mixer.music.load('collision.wav')s
                #pygame.mixer.music.play()
                #warning("Oh no! Crashed! Game Over",red,250,200)
                #game_over = True
